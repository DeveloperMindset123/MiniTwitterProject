...
export class User{ // userId generated by `_id` by mongoDb, this is the schema that will be used
...
export function CompareHashedText(inputText, hashedText) { //takes in unhashed text and hashed password
    const hashedInputText = hashedText(inputText);  //note: hashText was giving an warning, so it was repalced with hashedText instaed
